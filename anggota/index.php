                ...
                ?>
                    <div class="col-md-2" style="background-color:#F3EDD7">
                        <div class="card mt-5 bg-transparent mb-5">
                          <?php if ($gambar == NULL){
                            ?><img src="../public/img/buku/1.png" class="card-img-top mb-4" alt="gambar" style="width: 180px; height: 275px">
                            <?php
                          }else{ ?>
                            <img src="../admin/img/<?php echo $gambar; ?>" class="card-img-top mb-4" alt="gambar" style="width: 180px; height: 275px">
                            <?php } ?>
