				...
				<tbody>
					...
					?>
						<tr style="text-align: center;">
							...
							<td>
								<a href="?page=delete&nim=<?php print($value['username']) ?>" onclick="return confirm('Anda yakin ingin menghapus data Anggota <?php echo $value['nama']; ?> ?')" title="Hapus"><span class="glyphicon glyphicon-remove"></span></a>
							</td>
						</tr>
					<?php
						$no++;
